...
links:
  ...
  tests:
    - path: "HASKI-Frontend/src/pages/App/App.test.tsx"
      name: "App tests"
    - path: "HASKI-Frontend/src/pages/PageNotFound/PageNotFound.test.tsx"
      name: "PageNotFound"
    - path: "HASKI-Frontend/src/services/BufferContent/postBufferContent.test.tsx"
      name: "postBufferContent has expected behaviour"
    - path: "HASKI-Frontend/src/services/RoleContext/RoleContext.test.tsx"
      name: "Test Rolecontext"
    - path: "HASKI-Frontend/src/services/SnackbarContext/SnackbarContext.test.tsx"
      name: "Test SnackbarContext"
    - path: "HASKI-Frontend/src/services/SnackbarProvider/SnackbarProvider.test.tsx"
      name: "Test SnackbarProvider"
    - path: "HASKI-Frontend/src/services/ThemeContext/ThemeContext.test.tsx"
      name: "ThemeContext"
    - path: "HASKI-Frontend/src/services/ThemeProvider/ThemeProvider.test.tsx"
      name: "ThemeProvider"
    - path: "HASKI-Frontend/src/services/Viewport/Viewport.test.tsx"
      name: "Viewport hook tests"
    - path: "HASKI-Frontend/src/shared/internationalization.test.tsx"
      name: "i18n test"
    - path: "HASKI-Frontend/src/shared/logBuffer.config.test.tsx"
