---
id: HASKI-REQ-0072
title: Learning-Element-Empfehlungen abrufen
type: Functional
status: Implemented
...
Issue [#125](https://github.com/HASKI-RAK/HASKI-Backend/issues/125) fordert einen Backend-Service, der Studierenden eine sortierte Empfehlungsliste von Übungen in einem Topic bereitstellt. Diese Funktion operationalisiert SyRS-FUNC-001 (adaptive Lernpfade), indem sie konkrete REST-Schnittstellen definiert, mit denen Frontends die nächsten sinnvollen Learning Elements abrufen können. Der E2E-Test `backend/tests/e2e/test_api.py::TestApi::test_get_learning_element_recommendation` verifiziert Statuscodes und Antwortstruktur.
