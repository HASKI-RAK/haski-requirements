...
links:
  ...
  tests:
    - path: "backend/tests/e2e/test_api.py"
      name: "TestApi::test_api_create_course_from_moodle_without_start_date"
    - path: "backend/tests/e2e/test_api.py"
      name: "TestApi::test_api_create_course_from_moodle"
    - path: "backend/tests/unit/test_service.py"
      name: "test_get_courses_from_moodle"
    - path: "backend/tests/e2e/test_api.py"
      name: "TestApi::test_update_course_from_moodle"
    - path: "backend/tests/e2e/test_api.py"
      name: "TestApi::test_update_course_from_moodle_with_start_date"
